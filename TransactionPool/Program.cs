...
namespace TransactionPool
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            IBlock b1 = new Block(0, keyStore);
            IBlock b2 = new Block(1, keyStore);
            IBlock b3 = new Block(2, keyStore);
            IBlock b4 = new Block(3, keyStore);
            ...
            transaction.ArtistOrBand = "Nirvana";
